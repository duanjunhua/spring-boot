...
public class TreeUtil {
    ...
    public static void main(String[] args) {
        ...
        SysResource m1 = new SysResource();
        m1.setId(1L);
        m1.setParentId(0L);
        m1.setResourceName("系统管理");

        SysResource m2 = new SysResource();
        m2.setId(2L);
        m2.setParentId(1L);
        m2.setResourceName("用户管理");

        SysResource m3 = new SysResource();
        m3.setId(3L);
        m3.setParentId(1L);
        m3.setResourceName("角色管理");

        SysResource m4 = new SysResource();
        m4.setId(4L);
        m4.setParentId(0L);
        m4.setResourceName("大屏管理");
        ...
        // 构建树形，根节点父ID=0
        List<SysResource> tree = buildTree(
            resourceList,
            SysResource::getId,
            SysResource::getParentId,
            SysResource::getChildren,
        ...
        // 树平铺还原列表
        List<SysResource> flatList = TreeUtil.flatTree(tree, SysResource::getChildren);
    }
}
